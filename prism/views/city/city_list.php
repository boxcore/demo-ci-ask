    ...
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?php echo site_url('city/city_list') ?>" method="post">
        <div class="searchBar">
            <ul class="searchContent">
                <li>
                    <label>地区名：</label>
                    <input type="text" name="name" value="<?php echo $param['name'] ?>"/>
                </li>
                <li>
                    <label>地区拼音：</label>
...
<tr>
    ...
    <th width="80" orderField="accountCert">全拼</th>
    <th width="60" align="center" orderField="accountLevel">地区简称</th>
    <th width="70">修改时间</th>
    <th width="70">注册时间</th>
    <th width="70">操作</th>
</tr>
...
<tr target="sid_user" rel="<?php echo $v['city_id']; ?>">
    <td><input name="ids" value="<?php echo $v['city_id']; ?>" type="checkbox"></td>
    ...
    <td>
<!--        <a title="删除" target="ajaxTodo" href="--><?php //echo site_url('user/user_delete?uid='.$v['city_id'])?><!--" class="btnDel">删除</a>-->
        <a title="编辑" target="navTab" href="<?php echo site_url('user/user_edit?uid='.$v['city_id'])?>" class="btnEdit">编辑</a>
