...
<head>
    ...
    <link href="/static/admin/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/static/admin/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="/static/admin/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
    <link href="/static/admin/uploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
    <!--[if IE]>
    <link href="/static/admin/themes/css/ieHack.css" rel="stylesheet" type="text/css" media="screen"/>
    <![endif]-->

    <!--[if lte IE 9]>
    <script src="/static/admin/js/speedup.js" type="text/javascript"></script>
    <![endif]-->

    <script src="/static/admin/js/jquery-1.7.2.js" type="text/javascript"></script>
    <script src="/static/admin/js/jquery.cookie.js" type="text/javascript"></script>
    <script src="/static/admin/js/jquery.validate.js" type="text/javascript"></script>
    <script src="/static/admin/js/jquery.bgiframe.js" type="text/javascript"></script>
    <script src="/static/admin/xheditor/xheditor-1.2.1.min.js" type="text/javascript"></script>
    <script src="/static/admin/xheditor/xheditor_lang/zh-cn.js" type="text/javascript"></script>
    <script src="/static/admin/uploadify/scripts/jquery.uploadify.js" type="text/javascript"></script>
    ...
    <script src="/static/admin/js/dwz.core.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.util.date.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.validate.method.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.barDrag.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.drag.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.tree.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.accordion.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.ui.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.theme.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.switchEnv.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.alertMsg.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.contextmenu.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.navTab.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.tab.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.resize.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.dialog.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.dialogDrag.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.sortDrag.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.cssTable.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.stable.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.taskBar.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.ajax.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.pagination.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.database.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.datepicker.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.effects.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.panel.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.checkbox.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.history.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.combox.js" type="text/javascript"></script>
    <script src="/static/admin/js/dwz.print.js" type="text/javascript"></script>

    <!-- 可以用dwz.min.js替换前面全部dwz.*.js (注意：替换是下面dwz.regional.zh.js还需要引入)
    <script src="bin/dwz.min.js" type="text/javascript"></script>
    -->
    <script src="/static/admin/js/dwz.regional.zh.js" type="text/javascript"></script>
