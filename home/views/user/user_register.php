...
<div class="main">
    ...
    <div class="form">
        ...
        <form name="reg" action="http://ask.7808.cn/user/register.html" method="post" onsubmit="return docheck();">
...
<div class="sidebar">
    <p class="bd">已有账号？<a href="http://ask.7808.cn/user/login.html">马上登录！</a></p>
    <ul>
